...
public class App {
    ...
    public static void main(String a[]){
        ...
        while (continuar) {
            ...
            System.err.println("5. Busqueda con Heuristica (A*)");
            ...
            if (opcion == 1) {
                ...
                resultado = arbol.busquedaConHeuristica(estadoFinal);
                System.err.println("Camino de solucion (Búsqueda con Heurística): ");
            } else {
            ...
            System.out.println("Costo total: " + (costoUniforme - 1)); // -1 para no contar el estado inicial dos veces
